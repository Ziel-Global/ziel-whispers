...
--
-- Name: calculate_late_clockin(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.calculate_late_clockin() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
...
ALTER FUNCTION public.calculate_late_clockin() OWNER TO postgres;
...
--
-- Name: handle_new_user_leave_balances(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.handle_new_user_leave_balances() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
CREATE TABLE public.attendance (
    ...
    auto_clockout_notes text,
    is_late boolean DEFAULT false NOT NULL,
    minutes_late integer DEFAULT 0 NOT NULL,
    hours_late integer DEFAULT 0 NOT NULL,
    CONSTRAINT attendance_work_mode_check CHECK ((work_mode = ANY (ARRAY['onsite'::text, 'remote'::text])))
);
...
--
-- Name: auto_clockout_acks; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.auto_clockout_acks OWNER TO postgres;
...
--
-- Name: missed_logs; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.missed_logs (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    user_id uuid,
    log_date date NOT NULL,
...
ALTER TABLE public.missed_logs OWNER TO postgres;
...
CREATE TABLE public.users (
    ...
    reminder_offset_minutes integer DEFAULT 30 NOT NULL,
    avatar_url text,
    status text DEFAULT 'pending'::text NOT NULL,
...
--
-- Name: auto_clockout_acks auto_clockout_acks_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.auto_clockout_acks
    ADD CONSTRAINT auto_clockout_acks_pkey PRIMARY KEY (id);
...
--
-- Name: leave_balances leave_balances_user_id_leave_type_id_year_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: missed_logs missed_logs_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.missed_logs
    ADD CONSTRAINT missed_logs_pkey PRIMARY KEY (id);


--
-- Name: missed_logs missed_logs_user_id_log_date_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.missed_logs
    ADD CONSTRAINT missed_logs_user_id_log_date_key UNIQUE (user_id, log_date);
...
--
-- Name: idx_auto_clockout_acks_unique; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX idx_auto_clockout_acks_unique ON public.auto_clockout_acks USING btree (user_id, attendance_id);
...
--
-- Name: users on_user_created_leave_balances; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER on_user_created_leave_balances AFTER INSERT ON public.users FOR EACH ROW EXECUTE FUNCTION public.handle_new_user_leave_balances();


--
-- Name: attendance trg_calculate_late_clockin; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_calculate_late_clockin BEFORE INSERT ON public.attendance FOR EACH ROW EXECUTE FUNCTION public.calculate_late_clockin();
...
--
-- Name: attendance attendance_edited_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.attendance
    ADD CONSTRAINT attendance_edited_by_fkey FOREIGN KEY (edited_by) REFERENCES public.users(id);
...
-- Name: daily_logs daily_logs_project_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: missed_logs missed_logs_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.missed_logs
    ADD CONSTRAINT missed_logs_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id);
...
--
-- Name: project_members project_members_project_role_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.project_members
    ADD CONSTRAINT project_members_project_role_id_fkey FOREIGN KEY (project_role_id) REFERENCES public.project_roles(id);
...
--
-- Name: leave_balances Admin can delete leave balances; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Admin can delete leave balances" ON public.leave_balances FOR DELETE USING ((public.get_my_role() = 'admin'::text));


--
-- Name: attendance Admin can edit any attendance; employee own; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Admin can edit any attendance; employee own" ON public.attendance FOR UPDATE USING (((public.get_my_role() = 'admin'::text) OR (user_id = auth.uid())));


--
-- Name: leave_balances Admin can insert leave balances; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Admin can insert leave balances" ON public.leave_balances FOR INSERT WITH CHECK ((public.get_my_role() = 'admin'::text));


--
-- Name: missed_logs Admin can insert missed logs; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Admin can insert missed logs" ON public.missed_logs FOR INSERT WITH CHECK ((public.get_my_role() = 'admin'::text));


--
-- Name: users Admin can insert users; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Admin can insert users" ON public.users FOR INSERT TO authenticated WITH CHECK ((public.get_my_role() = 'admin'::text));


--
-- Name: announcements Admin can manage announcements; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Admin can manage announcements" ON public.announcements USING ((public.get_my_role() = 'admin'::text));


--
-- Name: leave_types Admin can manage leave types; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Admin can manage leave types" ON public.leave_types TO authenticated USING ((public.get_my_role() = 'admin'::text)) WITH CHECK ((public.get_my_role() = 'admin'::text));


--
-- Name: system_settings Admin can manage system settings; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Admin can manage system settings" ON public.system_settings TO authenticated USING ((public.get_my_role() = 'admin'::text)) WITH CHECK ((public.get_my_role() = 'admin'::text));


--
-- Name: users Admin can update any user; employee can update own; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Admin can update any user; employee can update own" ON public.users FOR UPDATE TO authenticated USING (((public.get_my_role() = 'admin'::text) OR (id = auth.uid())));


--
-- Name: leave_requests Admin can update any; employee can cancel own; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Admin can update any; employee can cancel own" ON public.leave_requests FOR UPDATE USING (((public.get_my_role() = 'admin'::text) OR (user_id = auth.uid())));


--
-- Name: leave_balances Admin can update leave balances; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Admin can update leave balances" ON public.leave_balances FOR UPDATE USING ((public.get_my_role() = 'admin'::text));


--
-- Name: audit_logs Admin can view all audit logs; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Admin can view all audit logs" ON public.audit_logs FOR SELECT USING ((public.get_my_role() = 'admin'::text));


--
-- Name: leave_balances Admin can view all; employee own; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Admin can view all; employee own" ON public.leave_balances FOR SELECT USING (((public.get_my_role() = ANY (ARRAY['admin'::text, 'manager'::text])) OR (user_id = auth.uid())));


--
-- Name: login_attempts Admin can view login attempts; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Admin can view login attempts" ON public.login_attempts FOR SELECT TO authenticated USING ((public.get_my_role() = 'admin'::text));


--
-- Name: clients Admin/Manager can insert clients; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Admin/Manager can insert clients" ON public.clients FOR INSERT WITH CHECK ((public.get_my_role() = ANY (ARRAY['admin'::text, 'manager'::text])));


--
-- Name: projects Admin/Manager can insert projects; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Admin/Manager can insert projects" ON public.projects FOR INSERT WITH CHECK ((public.get_my_role() = ANY (ARRAY['admin'::text, 'manager'::text])));


--
-- Name: client_action_items Admin/Manager can manage action items; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Admin/Manager can manage action items" ON public.client_action_items TO authenticated USING ((public.get_my_role() = ANY (ARRAY['admin'::text, 'manager'::text]))) WITH CHECK ((public.get_my_role() = ANY (ARRAY['admin'::text, 'manager'::text])));


--
-- Name: client_portal_messages Admin/Manager can manage portal messages; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Admin/Manager can manage portal messages" ON public.client_portal_messages TO authenticated USING ((public.get_my_role() = ANY (ARRAY['admin'::text, 'manager'::text]))) WITH CHECK ((public.get_my_role() = ANY (ARRAY['admin'::text, 'manager'::text])));


--
-- Name: project_members Admin/Manager can manage project members; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Admin/Manager can manage project members" ON public.project_members TO authenticated USING ((public.get_my_role() = ANY (ARRAY['admin'::text, 'manager'::text]))) WITH CHECK ((public.get_my_role() = ANY (ARRAY['admin'::text, 'manager'::text])));


--
-- Name: project_roles Admin/Manager can manage project roles; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Admin/Manager can manage project roles" ON public.project_roles TO authenticated USING ((public.get_my_role() = ANY (ARRAY['admin'::text, 'manager'::text]))) WITH CHECK ((public.get_my_role() = ANY (ARRAY['admin'::text, 'manager'::text])));


--
-- Name: clients Admin/Manager can update clients; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Admin/Manager can update clients" ON public.clients FOR UPDATE USING ((public.get_my_role() = ANY (ARRAY['admin'::text, 'manager'::text])));


--
-- Name: projects Admin/Manager can update projects; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Admin/Manager can update projects" ON public.projects FOR UPDATE USING ((public.get_my_role() = ANY (ARRAY['admin'::text, 'manager'::text])));


--
-- Name: attendance Admin/Manager can view all attendance; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Admin/Manager can view all attendance" ON public.attendance FOR SELECT USING (((public.get_my_role() = ANY (ARRAY['admin'::text, 'manager'::text])) OR (user_id = auth.uid())));


--
-- Name: leave_requests Admin/Manager can view all leave requests; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Admin/Manager can view all leave requests" ON public.leave_requests FOR SELECT USING (((public.get_my_role() = ANY (ARRAY['admin'::text, 'manager'::text])) OR (user_id = auth.uid())));


--
-- Name: daily_logs Admin/Manager can view all logs; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Admin/Manager can view all logs" ON public.daily_logs FOR SELECT USING (((public.get_my_role() = ANY (ARRAY['admin'::text, 'manager'::text])) OR (user_id = auth.uid())));


--
-- Name: missed_logs Admin/Manager can view all missed logs; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Admin/Manager can view all missed logs" ON public.missed_logs FOR SELECT USING (((public.get_my_role() = ANY (ARRAY['admin'::text, 'manager'::text])) OR (user_id = auth.uid())));
...
CREATE POLICY "Admin/Manager can view all users; employee own" ON public.users FOR SELECT TO authenticated USING (((public.get_my_role() = ANY (ARRAY['admin'::text, 'manager'::text])) OR (id = auth.uid())));


--
-- Name: clients Admin/Manager can view clients; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: announcements All can view relevant announcements; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "All can view relevant announcements" ON public.announcements FOR SELECT USING (((publish_at <= now()) AND ((audience = 'all'::text) OR (audience = ( SELECT users.department
   FROM public.users
  WHERE (users.id = auth.uid()))))));


--
-- Name: notifications Authenticated can insert notifications; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: project_roles Authenticated can view project roles; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Authenticated can view project roles" ON public.project_roles FOR SELECT TO authenticated USING (true);


--
-- Name: system_settings Authenticated users can read system settings; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: leave_types Authenticated users can view leave types; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: attendance Employees can insert own attendance; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Employees can insert own attendance" ON public.attendance FOR INSERT WITH CHECK ((user_id = auth.uid()));


--
-- Name: leave_requests Employees can insert own leave requests; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Employees can insert own leave requests" ON public.leave_requests FOR INSERT WITH CHECK ((user_id = auth.uid()));


--
-- Name: daily_logs Employees can insert own logs; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Employees can insert own logs" ON public.daily_logs FOR INSERT WITH CHECK ((user_id = auth.uid()));


--
-- Name: daily_logs Employees can update own unlocked logs; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Employees can update own unlocked logs" ON public.daily_logs FOR UPDATE USING ((((user_id = auth.uid()) AND (is_locked = false)) OR (public.get_my_role() = 'admin'::text)));
...
--
-- Name: auto_clockout_acks Users can insert own acks; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can insert own acks" ON public.auto_clockout_acks FOR INSERT WITH CHECK ((user_id = auth.uid()));
...
CREATE POLICY "Users can insert own audit logs" ON public.audit_logs FOR INSERT TO authenticated WITH CHECK (((auth.uid() IS NOT NULL) AND (actor_id = auth.uid())));


--
-- Name: announcement_reads Users can manage own reads; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can manage own reads" ON public.announcement_reads USING ((user_id = auth.uid()));
...
--
-- Name: auto_clockout_acks Users can view own acks; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can view own acks" ON public.auto_clockout_acks FOR SELECT USING ((user_id = auth.uid()));
...
CREATE POLICY "Users can view own notifications" ON public.notifications FOR SELECT USING (((user_id = auth.uid()) OR (public.get_my_role() = 'admin'::text)));


--
-- Name: announcement_reads; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: auto_clockout_acks; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: daily_logs; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: leave_types; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: missed_logs; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.missed_logs ENABLE ROW LEVEL SECURITY;
...
--
-- Name: project_roles; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION calculate_late_clockin(); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.calculate_late_clockin() TO anon;
GRANT ALL ON FUNCTION public.calculate_late_clockin() TO authenticated;
GRANT ALL ON FUNCTION public.calculate_late_clockin() TO service_role;
...
--
-- Name: FUNCTION handle_new_user_leave_balances(); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE announcement_reads; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE auto_clockout_acks; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.auto_clockout_acks TO anon;
GRANT ALL ON TABLE public.auto_clockout_acks TO authenticated;
GRANT ALL ON TABLE public.auto_clockout_acks TO service_role;
...
--
-- Name: TABLE daily_logs; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE missed_logs; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.missed_logs TO anon;
GRANT ALL ON TABLE public.missed_logs TO authenticated;
GRANT ALL ON TABLE public.missed_logs TO service_role;
...
--
-- Name: TABLE project_roles; Type: ACL; Schema: public; Owner: postgres
--
