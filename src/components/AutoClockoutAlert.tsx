      ...
      >
        ...
        <div className="space-y-3">
          <p className="text-sm text-muted-foreground">
            ...
            , so the system automatically clocked you out at {displayTime}.
          </p>
          <p className="text-sm text-muted-foreground">
            Please make it a habit to clock out at the end of your shift.
            Repeated occurrences may be noted in your attendance record.
          </p>
          <p className="text-sm text-muted-foreground">
          ...
          {unackedAutoClockouts.length > 1 && (
            <p className="text-xs text-muted-foreground bg-muted p-2 rounded">
              You have {unackedAutoClockouts.length - 1} more missed clock-out
              {unackedAutoClockouts.length > 2 ? "s" : ""} to acknowledge.
            </p>
          )}
        </div>
        <DialogFooter>
