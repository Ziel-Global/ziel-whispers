...
export const editButtonClass = "shrink-0 p-1.5 rounded bg-primary text-white hover:bg-black transition-colors";
...
export function DataRow({ children, onClick, className, gridCols }: DataRowProps) {
  return (
    <div
      className={cn(
...
export function RowSecondary({ children, className }: { children: React.ReactNode; className?: string }) {
  return <div className={cn("text-[12px] text-[#6b7280] mt-0.5 truncate", className)}>{children}</div>;
}

export function RowDataGrid({ children, className }: { children: React.ReactNode; className?: string }) {
  return (
...
export function RowDataItem({ label, children, className }: { label: string; children: React.ReactNode; className?: string }) {
  return (
...
export function RowBadgeItem({ label, children, className }: { label: string; children: React.ReactNode; className?: string }) {
  return (
    <div className={cn("min-w-0", className)}>
      <div className="text-[10px] uppercase tracking-wider text-[#9ca3af] font-medium md:hidden">{label}</div>
...
export function TableHeader({ children, className, gridCols }: { children: React.ReactNode; className?: string; gridCols?: string }) {
  return (
    <div className={cn(
