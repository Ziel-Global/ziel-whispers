    ...
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <Card className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <Label className="text-muted-foreground text-xs">Shift Start</Label>
            <p className="font-medium">{formatShiftTime(shiftStart)}</p>
          </div>
          <div>
            <Label className="text-muted-foreground text-xs">Shift End</Label>
            <p className="font-medium">{formatShiftTime(shiftEnd)}</p>
          </div>
        </div>
        <p className="text-sm text-muted-foreground bg-muted p-3 rounded-md">
          Contact your admin to change name, email, department, shift timing, or
          other details.
        </p>
        <Separator />
