...
const getNotificationIcon = (type: string) => {
  switch (type) {
    ...
    case "action_item_completed": return "✔️";
    case "blocker_created": return "⚠️";
    case "blocker_resolved": return "🔧";
    case "leave_request": return "📅";
    case "remote_work_request": return "🏠";
              ...
              >
                <div className="flex gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {meta?.message && (
                      <p className="text-sm text-muted-foreground mt-1">{meta.message}</p>
                    )}
                    {meta?.project_id && (
                      <span className="text-xs text-blue-600 mt-1 inline-block">Project notification</span>
                    )}
                  </div>
                </div>
              </Card>
