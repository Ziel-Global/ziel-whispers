  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex items-center justify-between">
        <h1 className="text-[32px] font-bold text-[#09090B] tracking-tight leading-none mb-2">Projects</h1>
        <Button onClick={() => navigate("/projects/new")} className="bg-[#EC6824] hover:bg-[#c4541a] text-white rounded-md h-10 px-4 text-[13px] font-semibold shadow-sm transition-colors">
      ...
      {isLoading ? (
        ...
        <div className="border border-[#E4E4E7] rounded-[16px] bg-white py-12 text-center text-[#71717A] text-[13px] shadow-sm">No projects found</div>
      ) : (
            ...
            {filtered.map((p) => (
              ...
              >
                ...
                <div className="min-w-0">
                  <p className="text-[14px] font-bold text-[#18181B] truncate tracking-tight">{p.name}</p>
                ...
                {/* Status */}
                <div>
                  <Badge className={`text-[11px] font-bold px-2.5 py-0.5 rounded-md border-transparent ${p.status === "active" ? "bg-[#DCFCE7] text-[#166534]" : "bg-[#F4F4F5] text-[#71717A]"}`}>
                    {p.status}
                  </Badge>
                </div>
