...
DROP POLICY IF EXISTS "Admin/Manager can manage project members" ON project_members;
...
DROP POLICY IF EXISTS "Authenticated can view project roles" ON project_roles;
CREATE POLICY "Authenticated can view project roles"
ON public.project_roles FOR SELECT TO authenticated
USING (true);

DROP POLICY IF EXISTS "Admin/Manager can manage project roles" ON project_roles;
